    ...
    public partial class FormTransaksiPenjualan : Form
    {
        ...
        private void FormTransaksiPenjualan_Load(object sender, EventArgs e)
        {
            ...
            DataGridViewButtonColumn btnHapus = new DataGridViewButtonColumn
            {
                ...
                HeaderText = "Aksi",
                Text = "Hapus",
                UseColumnTextForButtonValue = true // Teks "Hapus" akan muncul di tombol
            };
        ...
        private void btbSimpan_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = Koneksi.GetConnection())
            {
                ...
                try
                {
                    ...
                    SqlCommand cmdPenjualan = new SqlCommand("INSERT INTO Penjualan (Tanggal, TotalHarga) VALUES (@tgl,@total); SELECT SCOPE_IDENTITY(); ", conn, trx);
